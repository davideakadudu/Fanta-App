...
const guidePlayers = [
  ...
  ['A','1','Malen','Roma','high','Super-top: prevedi 100–125M'], ['A','1','Lautaro Martínez','Inter','high','Punta di riferimento'], ['A','1','Marcus Thuram','Inter','high','Gol e sistema consolidato'], ['A','1','Højlund','Napoli','high','Prima fascia: titolare e centrale nel Napoli'], ['A','1','Kean','Fiorentina','high','Volume tiri e rigori'],
  ['A','2','Dovbyk','Bologna','value','Da prezzo contenuto: concorrenza e titolarità da verificare'], ['A','2','David','Juventus','high','Profilo da bonus'], ['A','2','Castro','Bologna','high','Crescita e centralità'], ['A','2','Douvikas','Como','value','Da seguire per titolarità'], ['A','2','Yildiz','Juventus','high','Qualità, ma prezzo da controllare'],
